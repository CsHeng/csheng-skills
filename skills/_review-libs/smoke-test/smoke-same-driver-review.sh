...
usage() {
  cat <<'USAGE'
Usage:
  skills/_review-libs/smoke-test/smoke-same-driver-review.sh [plan|code-impl|design|all|eval] [options]
...
Notes:
  - This script tests the direct same-driver reviewer path.
