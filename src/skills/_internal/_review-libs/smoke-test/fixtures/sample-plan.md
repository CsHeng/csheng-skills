...
- `bash skills/_review-libs/smoke-test/smoke-same-driver-review.sh plan --reviewer claude --timeout 1800 --plan skills/_review-libs/smoke-test/fixtures/sample-plan.md`
- Optional local fallback when the preferred reviewer is unavailable: `bash skills/_review-libs/smoke-test/smoke-same-driver-review.sh plan --reviewer codex --timeout 600 --plan skills/_review-libs/smoke-test/fixtures/sample-plan.md`
