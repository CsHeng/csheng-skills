...
EOF
  ...
  assert_contains_line "$design_out_of_scope_refs" "skills/_review-libs/drivers/codex.sh" "design should include out of scope file refs"
...
EOF
  ...
  reviewer_schema="$ROOT_DIR/skills/_review-libs/schemas/reviewer-output.schema.json"
