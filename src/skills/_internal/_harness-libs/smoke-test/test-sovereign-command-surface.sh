...
main() {
  ...
  assert_contains "README.md" "/analyze-project|/design-change|/plan-change|/implement-change|/review-change|/sync-truth|/close-change" "README should document top-level slash commands"
