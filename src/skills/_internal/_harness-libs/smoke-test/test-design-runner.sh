...
EOF
  ...
  assert_contains "$ROOT_DIR/commands/design-change.md" 'classification record' "design command should enforce classification"
  ...
  assert_contains "$ROOT_DIR/commands/design-change.md" 'coding:review-change' "design command should route through top-level review gate"
  assert_contains "$ROOT_DIR/commands/design-change.md" 'bounded design brief|candidate findings' "design command should define bounded review"
